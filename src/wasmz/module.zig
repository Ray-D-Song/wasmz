...
fn decodeAndLower(
    ...
    switch (code) {
        ...
        // i32 binary
        .i32_add => try lower.lowerI32Add(saved_r0, saved_fp0),
        .i32_sub => try lower.lowerI32Sub(saved_r0, saved_fp0),
        .i32_mul => try lower.lowerI32Mul(saved_r0, saved_fp0),
        .i32_div_s => try lower.lowerI32DivS(saved_r0, saved_fp0),
        .i32_div_u => try lower.lowerI32DivU(saved_r0, saved_fp0),
        .i32_rem_s => try lower.lowerI32RemS(saved_r0, saved_fp0),
        .i32_rem_u => try lower.lowerI32RemU(saved_r0, saved_fp0),
        .i32_and => try lower.lowerI32And(saved_r0, saved_fp0),
        .i32_or => try lower.lowerI32Or(saved_r0, saved_fp0),
        .i32_xor => try lower.lowerI32Xor(saved_r0, saved_fp0),
        .i32_shl => try lower.lowerI32Shl(saved_r0, saved_fp0),
        .i32_shr_s => try lower.lowerI32ShrS(saved_r0, saved_fp0),
        .i32_shr_u => try lower.lowerI32ShrU(saved_r0, saved_fp0),
        .i32_rotl => try lower.lowerI32Rotl(saved_r0, saved_fp0),
        .i32_rotr => try lower.lowerI32Rotr(saved_r0, saved_fp0),

        // i64 binary
        .i64_add => try lower.lowerI64Add(saved_r0, saved_fp0),
        .i64_sub => try lower.lowerI64Sub(saved_r0, saved_fp0),
        .i64_mul => try lower.lowerI64Mul(saved_r0, saved_fp0),
        .i64_div_s => try lower.lowerI64DivS(saved_r0, saved_fp0),
        .i64_div_u => try lower.lowerI64DivU(saved_r0, saved_fp0),
        .i64_rem_s => try lower.lowerI64RemS(saved_r0, saved_fp0),
        .i64_rem_u => try lower.lowerI64RemU(saved_r0, saved_fp0),
        .i64_and => try lower.lowerI64And(saved_r0, saved_fp0),
        .i64_or => try lower.lowerI64Or(saved_r0, saved_fp0),
        .i64_xor => try lower.lowerI64Xor(saved_r0, saved_fp0),
        .i64_shl => try lower.lowerI64Shl(saved_r0, saved_fp0),
        .i64_shr_s => try lower.lowerI64ShrS(saved_r0, saved_fp0),
        .i64_shr_u => try lower.lowerI64ShrU(saved_r0, saved_fp0),
        .i64_rotl => try lower.lowerI64Rotl(saved_r0, saved_fp0),
        .i64_rotr => try lower.lowerI64Rotr(saved_r0, saved_fp0),

        // f32 binary
        .f32_add => try lower.lowerF32Add(saved_r0, saved_fp0),
        .f32_sub => try lower.lowerF32Sub(saved_r0, saved_fp0),
        .f32_mul => try lower.lowerF32Mul(saved_r0, saved_fp0),
        .f32_div => try lower.lowerF32Div(saved_r0, saved_fp0),
        .f32_min => try lower.lowerF32Min(saved_r0, saved_fp0),
        .f32_max => try lower.lowerF32Max(saved_r0, saved_fp0),
        .f32_copysign => try lower.lowerF32Copysign(saved_r0, saved_fp0),

        // f64 binary
        .f64_add => try lower.lowerF64Add(saved_r0, saved_fp0),
        .f64_sub => try lower.lowerF64Sub(saved_r0, saved_fp0),
        .f64_mul => try lower.lowerF64Mul(saved_r0, saved_fp0),
        .f64_div => try lower.lowerF64Div(saved_r0, saved_fp0),
        .f64_min => try lower.lowerF64Min(saved_r0, saved_fp0),
        .f64_max => try lower.lowerF64Max(saved_r0, saved_fp0),
        .f64_copysign => try lower.lowerF64Copysign(saved_r0, saved_fp0),

        // i32 unary
        .i32_clz => try lower.lowerI32Clz(),
        .i32_ctz => try lower.lowerI32Ctz(),
        .i32_popcnt => try lower.lowerI32Popcnt(),

        // i64 unary
        .i64_clz => try lower.lowerI64Clz(),
        .i64_ctz => try lower.lowerI64Ctz(),
        .i64_popcnt => try lower.lowerI64Popcnt(),

        // f32 unary
        .f32_abs => try lower.lowerF32Abs(),
        .f32_neg => try lower.lowerF32Neg(),
        .f32_ceil => try lower.lowerF32Ceil(),
        .f32_floor => try lower.lowerF32Floor(),
        .f32_trunc => try lower.lowerF32Trunc(),
        .f32_nearest => try lower.lowerF32Nearest(),
        .f32_sqrt => try lower.lowerF32Sqrt(),

        // f64 unary
        .f64_abs => try lower.lowerF64Abs(),
        .f64_neg => try lower.lowerF64Neg(),
        .f64_ceil => try lower.lowerF64Ceil(),
        .f64_floor => try lower.lowerF64Floor(),
        .f64_trunc => try lower.lowerF64Trunc(),
        .f64_nearest => try lower.lowerF64Nearest(),
        .f64_sqrt => try lower.lowerF64Sqrt(),

        // i32 comparisons
        .i32_eqz => try lower.lowerI32Eqz(),
        .i32_eq => try lower.lowerI32Eq(),
        .i32_ne => try lower.lowerI32Ne(),
        .i32_lt_s => try lower.lowerI32LtS(),
        .i32_lt_u => try lower.lowerI32LtU(),
        .i32_gt_s => try lower.lowerI32GtS(),
        .i32_gt_u => try lower.lowerI32GtU(),
        .i32_le_s => try lower.lowerI32LeS(),
        .i32_le_u => try lower.lowerI32LeU(),
        .i32_ge_s => try lower.lowerI32GeS(),
        .i32_ge_u => try lower.lowerI32GeU(),

        // i64 comparisons
        .i64_eqz => try lower.lowerI64Eqz(),
        .i64_eq => try lower.lowerI64Eq(),
        .i64_ne => try lower.lowerI64Ne(),
        .i64_lt_s => try lower.lowerI64LtS(),
        .i64_lt_u => try lower.lowerI64LtU(),
        .i64_gt_s => try lower.lowerI64GtS(),
        .i64_gt_u => try lower.lowerI64GtU(),
        .i64_le_s => try lower.lowerI64LeS(),
        .i64_le_u => try lower.lowerI64LeU(),
        .i64_ge_s => try lower.lowerI64GeS(),
        .i64_ge_u => try lower.lowerI64GeU(),

        // f32 comparisons
        .f32_eq => try lower.lowerF32Eq(),
        .f32_ne => try lower.lowerF32Ne(),
        .f32_lt => try lower.lowerF32Lt(),
        .f32_gt => try lower.lowerF32Gt(),
        .f32_le => try lower.lowerF32Le(),
        .f32_ge => try lower.lowerF32Ge(),

        // f64 comparisons
        .f64_eq => try lower.lowerF64Eq(),
        .f64_ne => try lower.lowerF64Ne(),
        .f64_lt => try lower.lowerF64Lt(),
        .f64_gt => try lower.lowerF64Gt(),
        .f64_le => try lower.lowerF64Le(),
        .f64_ge => try lower.lowerF64Ge(),

        // Conversions & sign-extension
        .i32_wrap_i64 => try lower.lowerI32WrapI64(),
        .i32_trunc_f32_s => try lower.lowerI32TruncF32S(),
        .i32_trunc_f32_u => try lower.lowerI32TruncF32U(),
        .i32_trunc_f64_s => try lower.lowerI32TruncF64S(),
        .i32_trunc_f64_u => try lower.lowerI32TruncF64U(),
        .i64_extend_i32_s => try lower.lowerI64ExtendI32S(),
        .i64_extend_i32_u => try lower.lowerI64ExtendI32U(),
        .i64_trunc_f32_s => try lower.lowerI64TruncF32S(),
        .i64_trunc_f32_u => try lower.lowerI64TruncF32U(),
        .i64_trunc_f64_s => try lower.lowerI64TruncF64S(),
        .i64_trunc_f64_u => try lower.lowerI64TruncF64U(),
        .f32_convert_i32_s => try lower.lowerF32ConvertI32S(),
        .f32_convert_i32_u => try lower.lowerF32ConvertI32U(),
        .f32_convert_i64_s => try lower.lowerF32ConvertI64S(),
        .f32_convert_i64_u => try lower.lowerF32ConvertI64U(),
        .f32_demote_f64 => try lower.lowerF32DemoteF64(),
        .f64_convert_i32_s => try lower.lowerF64ConvertI32S(),
        .f64_convert_i32_u => try lower.lowerF64ConvertI32U(),
        .f64_convert_i64_s => try lower.lowerF64ConvertI64S(),
        .f64_convert_i64_u => try lower.lowerF64ConvertI64U(),
        .f64_promote_f32 => try lower.lowerF64PromoteF32(),
        .i32_reinterpret_f32 => try lower.lowerI32ReinterpretF32(),
        .i64_reinterpret_f64 => try lower.lowerI64ReinterpretF64(),
        .f32_reinterpret_i32 => try lower.lowerF32ReinterpretI32(),
        .f64_reinterpret_i64 => try lower.lowerF64ReinterpretI64(),
        .i32_extend8_s => try lower.lowerI32Extend8S(),
        .i32_extend16_s => try lower.lowerI32Extend16S(),
        .i64_extend8_s => try lower.lowerI64Extend8S(),
        .i64_extend16_s => try lower.lowerI64Extend16S(),
        .i64_extend32_s => try lower.lowerI64Extend32S(),

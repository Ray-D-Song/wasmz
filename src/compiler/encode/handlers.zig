...
pub fn handlerFor(op: Op, t: *const table.HandlerTable) Handler {
    return switch (op) {
        ...
        .i32_add_r => t.i32_add_r,
        .i32_sub_r => t.i32_sub_r,
        .i32_mul_r => t.i32_mul_r,
        .i32_and_r => t.i32_and_r,
        .i32_or_r => t.i32_or_r,
        .i32_xor_r => t.i32_xor_r,
        .i32_shl_r => t.i32_shl_r,
        .i32_shr_s_r => t.i32_shr_s_r,
        .i32_shr_u_r => t.i32_shr_u_r,
        .i64_add_r => t.i64_add_r,
        .i64_sub_r => t.i64_sub_r,
        .i64_mul_r => t.i64_mul_r,
        .i64_and_r => t.i64_and_r,
        .i64_or_r => t.i64_or_r,
        .i64_xor_r => t.i64_xor_r,
        .i64_shl_r => t.i64_shl_r,
        .i64_shr_s_r => t.i64_shr_s_r,
        .i64_shr_u_r => t.i64_shr_u_r,
        .f32_add_r => t.f32_add_r,
        .f32_sub_r => t.f32_sub_r,
        .f32_mul_r => t.f32_mul_r,
        .f32_div_r => t.f32_div_r,
        .f64_add_r => t.f64_add_r,
        .f64_sub_r => t.f64_sub_r,
        .f64_mul_r => t.f64_mul_r,
        .f64_div_r => t.f64_div_r,
        .r0_load => t.r0_load,
        .fp0_load => t.fp0_load,
        .i32_add_r_ret => t.i32_add_r_ret,
        .i32_sub_r_ret => t.i32_sub_r_ret,
        .i64_add_r_ret => t.i64_add_r_ret,
        .i64_sub_r_ret => t.i64_sub_r_ret,

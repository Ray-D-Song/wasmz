...
pub const HandlerTable = struct {
    ...
    call_to_local_0: Handler,
    call_to_local_1: Handler,
    call_to_local_2: Handler,
    call_to_local_3: Handler,
    call_to_local_7: Handler,
    call_leaf: Handler,
    call_leaf_0: Handler,
    call_leaf_1: Handler,
    call_leaf_2: Handler,
    ...
    r0_load: Handler,
    fp0_load: Handler,
    i32_add_r_ret: Handler,
    i32_sub_r_ret: Handler,
    i64_add_r_ret: Handler,
    i64_sub_r_ret: Handler,

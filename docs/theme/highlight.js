...
hljs.registerLanguage("zig",function(e){const t={keyword:"align allowzero and anyframe anyerror anyopaque anytype asm async await break callconv catch comptime const continue defer else enum errdefer error export extern false fn for if inline linksection noalias noinline nosuspend null opaque or orelse packed pub resume return struct suspend switch test true try type undefined union unreachable usingnamespace var volatile while",literal:"true false null undefined",built_in:"i8 i16 i32 i64 i128 u8 u16 u32 u64 u128 f16 f32 f64 usize isize c_short c_int c_long c_longlong c_ushort c_uint c_ulong c_ulonglong c_float c_double c_void anytype noreturn anyerror anyframe anyopaque"};return{name:"Zig",aliases:["zig"],keywords:t,illegal:"</",contains:[e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE,e.inherit(e.QUOTE_STRING_MODE,{illegal:null}),{scope:"number",variants:[{begin:/\b[0-9]+(\.[0-9]+)?([eE][+-]?[0-9]+)?\b/},{begin:/\b0x[a-fA-F0-9]+\b/},{begin:/\b0o[0-7]+\b/},{begin:/\b0b[01]+\b/}]},{scope:"function",beginKeywords:"fn",end:/\{/,excludeEnd:!0,contains:[e.inherit(e.TITLE_MODE,{begin:/[a-zA-Z_][a-zA-Z0-9_]*/}),{begin:/\(/,end:/\)/,contains:[{scope:"params",begin:/[a-zA-Z_][a-zA-Z0-9_]*:/}]}]},{scope:"meta",begin:/@[a-zA-Z_][a-zA-Z0-9_]*/}]}});
